...
public record SuggestionsResponse(
    @Schema(
        ...
        example = "[{\"symbol\":\"AAPL\",\"name\":\"Apple Inc.\",\"exchange\":\"NASDAQ\",\"type\":\"Common Stock\",\"region\":\"US\",\"marketCap\":\"Large Cap\",\"currency\":\"USD\"}]"
    )
    ...
    public record TickerSuggestionDto(
        ...
        @Schema(
            description = "Geographic region of the company",
            example = "US"
        )
        String region,
